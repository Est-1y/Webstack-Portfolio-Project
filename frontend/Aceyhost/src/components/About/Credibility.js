      ...
      <div className="flex flex-col justify-center  px-10 md:px-16 sm:grid sm:grid-cols-2  lg:grid-cols-4 gap-10">
        ...
        <div className="text-center">
          <div className="bg-zinc-800 rounded-[50px] rounded-tr-none hover:border border-zinc-400 duration-500 text-center px-8 py-10 inline-block w-[280px]">
            ...
            <p className="text-[18px]">
              Our team of professionals is highly trained and brings extensive on-the-job expertise to ensure exceptional hosting experiences.
            </p>
          </div>
        </div>
        ...
        <div className="text-center">
          <div className="bg-zinc-800 rounded-[50px] rounded-tr-none hover:border border-zinc-400 duration-500 text-center px-8 py-10 inline-block w-[280px]">
            ...
            <p className="text-[18px]">
              We provide everything necessary to ensure the job is done right.
            </p>
          </div>
        </div>
        ...
        <div className="text-center">
          <div className="bg-zinc-800 rounded-[50px] rounded-tr-none hover:border border-zinc-400 duration-500 text-center px-8 py-10 inline-block w-[280px]">
            ...
            <p className="text-[18px]">
              We create and deliver exceptional hosting solutions on time and within budget.
            </p>
          </div>
        </div>
      </div>
